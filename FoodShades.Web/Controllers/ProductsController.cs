...
namespace FoodShades.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,Price,UnitOfMeasure,Size,ProductImageFileUrl,ProductImageContentType,CategoryId,Photo")] ProductViewModel productViewModel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewBag.ProuctImageFileUrl = product.ProductImageFileUrl;
            ViewData["CategoryId"] = new SelectList(_context.Category, "CategoryId", "CategoryName", productViewModel.CategoryId);
            return View(productViewModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductDescription,Price,UnitOfMeasure,Size,ProductImageFileUrl,ProductImageContentType,CategoryId,Photo")] ProductViewModel productViewModel)
        {
